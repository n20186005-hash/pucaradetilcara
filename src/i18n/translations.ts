...
export const translations: Record<Locale, Translations> = {
  zh: {
    ...
    visiting: {
      ...
      hours: { title: "开放时间", content: "周二至周日：**09:00–18:00**\n周一闭馆（公共假日除外）\n建议最晚于 16:30 前入内以确保充分游览。", note: "开放时间可能随季节和特殊活动调整，建议出发前查看官方网站确认。" },
    ...
    gallery: { title: "照片集锦", viewMore: "在 Google Maps 查看更多照片" },
    reviews: {
      title: "游客评价与周边探索",
    ...
    faq: { title: "常见问题", subtitle: "深入了解 Pucará de Tilcara", items: [
      ...
      { question: "遗址的开放时间和门票情况是怎样的？", answer: "开放时间为周二至周日 09:00–18:00（周一闭馆，公共假日除外）。需购买门票，票价因居民/非居民身份而异。遗址由布宜诺斯艾利斯大学（UBA）管理，建议访问 tilcara.filo.uba.ar 查看最新信息。" },
  ...
  en: {
    ...
    faq: { title: "Frequently Asked Questions", subtitle: "Learn More About Pucará de Tilcara", items: [
      ...
      { question: "What are the opening hours and ticket prices?", answer: "The site is open Tuesday to Sunday, 09:00–18:00 (closed Mondays except public holidays). An entrance fee applies; rates vary depending on residency status. The site is managed by the University of Buenos Aires — visit tilcara.filo.uba.ar for the latest information." },
  ...
  es: {
    ...
    faq: { title: "Preguntas Frecuentes", subtitle: "Conocé Más Sobre el Pucará de Tilcara", items: [
      ...
      { question: "¿Cuáles son los horarios y el precio de la entrada?", answer: "Está abierto de martes a domingo, 09:00–18:00 (cerrado los lunes excepto feriados). Se cobra entrada; las tarifas varían según residencia. El sitio es administrado por la Universidad de Buenos Aires — consultá tilcara.filo.uba.ar para información actualizada." },
  ...
  it: {
    ...
    visiting: {
      ...
      hours: { title: "Orari", content: "Da martedì a domenica: **09:00–18:00**\nChiuso il lunedì (eccetto festivi)\nSi consiglia l'ingresso entro le 16:30 per una visita completa.", note: "Gli orari possono variare in base alla stagione e agli eventi speciali; consultare il sito web ufficiale prima della visita." },
    ...
    faq: { title: "Domande Frequenti", subtitle: "Scopri di Più sul Pucará de Tilcara", items: [
      ...
      { question: "Quali sono gli orari e il prezzo del biglietto?", answer: "È aperto da martedì a domenica, 09:00–18:00 (chiuso il lunedì eccetto festivi). L'ingresso è a pagamento; le tariffe variano in base alla residenza. Il sito è gestito dall'Università di Buenos Aires — consulta tilcara.filo.uba.ar per informazioni aggiornate." },
